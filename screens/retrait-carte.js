...
export default function Retrait({navigation})  {
  ...
  useEffect(()=>{
    navigation.setOptions({title: "Retrait"});
    },[])
  ...
  const handlePress = async () => {
    ...
    // algo
    fetch(`https://adores.cloud/api/retrait-carte.php`,{
      method:'post',
      header:{
...
<Text style={styles.userCode}>Pour le retrait, veuillez saisir un montant et un numéro de téléphone ayant un compte Wave (Sans l'indicatif) puis valider et vous recevrez immédiatement la somme sur votre compte Wave</Text>
